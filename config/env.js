/**
 * Node-only environment validation. Do not import from Vite / browser code.
...
/**
 * Returns validated local runtime variables for scripts and tooling.
...
export function getLocalEnv() {
  loadRootEnv();
  return {
    apiUrl: requiredNonEmpty('VITE_API_BASE_URL'),
    jwtSecret: requiredNonEmpty('JWT_SECRET')
  };
}
