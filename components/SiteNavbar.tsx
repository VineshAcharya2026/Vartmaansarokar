...
const SiteNavbar: React.FC<SiteNavbarProps> = ({ onOpenAuthModal, onOpenSubscriptionPopup }) => {
  ...
  const handleSubscribe = () => {
    if (onOpenSubscriptionPopup) {
      onOpenSubscriptionPopup();
    } else {
