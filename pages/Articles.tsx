...
import { NEWS_CATEGORIES } from '../vartmaan-shared-constants';
import { buildCategorySlug, resolveAssetUrl } from '../utils/app';
import { translateCategory } from '../utils/i18n';
import { ArrowRight, Bookmark, Clock, User, Share2, Mail } from 'lucide-react';

const Articles: React.FC = () => {
  const { news, currentUser, openSubscriptionPopup } = useApp();
    ...
    <div className="min-h-screen bg-[#FAF7F2]">
      ...
      {(!currentUser ||
        ...
        <button
          ...
          className="fixed bottom-6 right-4 z-[90] flex items-center gap-2 rounded-full bg-[#800000] px-4 py-3 text-sm font-black uppercase tracking-wider text-white shadow-xl hover:bg-red-900 md:bottom-8 md:right-8"
